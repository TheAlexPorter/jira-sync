...
Verify the workflow plugin is available by checking if the `workflow:implement` command exists.

Use the Glob tool to check multiple possible install locations:
- `~/.claude/plugins/cache/*/workflow/*/commands/implement.md`
- `~/.claude/plugins/*/commands/implement.md`
...
Install it, then run /jira:implement again.
```
